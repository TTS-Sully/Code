...
try {
    ...
    foreach ($user in $user_list) {
        $installers = @(Get-ChildItem -Path C:\users\$user -r -fi "OneLaunch*.exe" | ForEach-Object { $_.FullName })
        foreach ($install in $installers) {
            if (test-path -Path $install) {
                Remove-Item -Path $install -ErrorAction SilentlyContinue
                if (test-path -Path $install) {
        ...
        if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunch.lnk") {
            Remove-Item -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunch.lnk" -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunch.lnk") {
        ...
        if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchChromium.lnk") {
            Remove-Item -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchChromium.lnk" -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchChromium.lnk") {
        ...
        if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchUpdater.lnk") {
            Remove-Item -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchUpdater.lnk" -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\OneLaunchUpdater.lnk") {
        ...
        if (test-path -Path "C:\Users\$user\desktop\OneLaunch.lnk") {
            Remove-Item -Path "C:\Users\$user\desktop\OneLaunch.lnk" -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\desktop\OneLaunch.lnk") {
        ...
        if (test-path -Path "C:\Users\$user\OneDrive\Desktop\OneLaunch.lnk") {
            Remove-Item -Path "C:\Users\$user\OneDrive\desktop\OneLaunch.lnk" -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\OneDrive\desktop\OneLaunch.lnk") {
        ...
        if (test-path -Path "C:\Users\$user\appdata\local\OneLaunch") {
            Remove-Item -Path "C:\Users\$user\appdata\local\OneLaunch" -Force -Recurse -ErrorAction SilentlyContinue
            if (test-path -Path "C:\Users\$user\appdata\local\OneLaunch") {
    ...
    foreach ($sid in $sid_list) {
        if ($sid -notlike "*_Classes*") {
            ...
            $startupkeys = (Get-Item "Registry::$sid\Software\Microsoft\Windows\CurrentVersion\Run").Property
    ...
    if (test-path "C:\windows\system32\tasks\OneLaunchLaunchTask") {
        Remove-Item -Path "C:\windows\system32\tasks\OneLaunchLaunchTask" -ErrorAction SilentlyContinue
        if (test-path "C:\windows\system32\tasks\OneLaunchLaunchTask") {
    ...
    if (test-path "C:\windows\system32\tasks\ChromiumLaunchTask") {
        Remove-Item -Path "C:\windows\system32\tasks\ChromiumLaunchTask" -ErrorAction SilentlyContinue
        if (test-path "C:\windows\system32\tasks\ChromiumLaunchTask") {
    ...
    if (test-path "C:\windows\system32\tasks\OneLaunchUpdateTask") {
        Remove-Item -Path "C:\windows\system32\tasks\OneLaunchUpdateTask" -ErrorAction SilentlyContinue
        if (test-path "C:\windows\system32\tasks\OneLaunchUpdateTask") {
