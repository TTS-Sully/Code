...
if(Test-Path $TTSPath\Maintenance-v5.ps1 -PathType Leaf) {
    Remove-Item -Path $TTSPath\Maintenance-v5.ps1
}

if(Test-Path $TTSPath\Maintenance-v6.ps1 -PathType Leaf) {
    Remove-Item -Path $TTSPath\Maintenance-v6.ps1
}
...
Move-Item -Path Maintenance-v6.ps1 -Destination $TTSPath\Maintenance-v6.ps1
